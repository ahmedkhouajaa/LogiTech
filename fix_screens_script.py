...
# 1. Fix mobile_module_config.dart
file1 = "d:/LogiTech/lib/mobile/utils/mobile_module_config.dart"
with open(file1, "r", encoding="utf-8") as f:
    c = f.read()
if "sidebar_menu.dart" not in c:
    c = c.replace("import '../../utils/constants.dart';", "import '../../utils/constants.dart';\nimport '../../widgets/sidebar_menu.dart';")
    with open(file1, "w", encoding="utf-8") as f:
        f.write(c)

# 2. Fix mobile_generic_list_screen.dart
file2 = "d:/LogiTech/lib/mobile/widgets/mobile_generic_list_screen.dart"
...
# 3. Update generate_screens.py
gen_file = "d:/LogiTech/generate_screens.py"
with open(gen_file, "r", encoding="utf-8") as f:
    gen_content = f.read()

# Fix configs
gen_content = gen_content.replace('("credit_notes", "CreditNotes", "note", "CreditNotesLoaded", "LoadCreditNotes", "notes", "DeleteCreditNote"',
                                  '("credit_notes", "CreditNotes", "note", "CreditNotesLoaded", "LoadCreditNotes", "creditNotes", "DeleteCreditNote"')

gen_content = gen_content.replace('("purchase_invoices", "PurchaseInvoices", "invoice", "PurchaseInvoicesLoaded", "LoadPurchaseInvoices", "invoices", "DeletePurchaseInvoice"',
                                  '("purchase_invoices", "PurchaseInvoices", "invoice", "PurchaseInvoicesLoaded", "LoadPurchaseInvoices", "purchaseInvoices", "DeletePurchaseInvoice"')

gen_content = gen_content.replace('("transactions", "TreasuryTransactions", "transaction", "TreasuryTransactionsLoaded", "LoadTreasuryTransactions", "transactions", "DeleteTreasuryTransaction"',
                                  '("treasury_transactions", "TreasuryTransactions", "transaction", "TreasuryTransactionsLoaded", "LoadTreasuryTransactions", "transactions", "DeleteTreasuryTransaction"')

gen_content = gen_content.replace('("stock", "Stock", "item", "StockLoaded", "LoadStock", "items", "DeleteStock"',
                                  '("stock", "Stock", "item", "StockLoaded", "LoadStock", "movements", "LoadStock"') # use LoadStock as dummy for delete

# Add extra imports for state/event just in case
template_fix = """import '../../blocs/{bloc_file}/{bloc_file}_bloc.dart';
// import '../../screens/{screen_create_file}.dart'; // Adjusted imports if needed
"""

new_template_fix = """import '../../blocs/{bloc_file}/{bloc_file}_bloc.dart';
import '../../widgets/sidebar_menu.dart';
// Try importing state and event if they exist
import '../../blocs/{bloc_file}/{bloc_file}_state.dart' hide {bloc_class}State;
import '../../blocs/{bloc_file}/{bloc_file}_event.dart' hide {bloc_class}Event;
// import '../../screens/{screen_create_file}.dart'; // Adjusted imports if needed
"""
gen_content = gen_content.replace(template_fix, new_template_fix)

# Wait, "import ... hide ..." might be an error if the file doesn't exist.
# Let's write a better python script that actually checks if the files exist.

with open("d:/LogiTech/generate_screens_fixed.py", "w", encoding="utf-8") as f:
    f.write("""import os
