                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        formatDateShort(widget.invoice.date),
                  ...
                  children: [
                    Expanded(
                      child: _buildAmountBlock(
                        'Montant total',
                        formatCurrencyDT(widget.invoice.totalTTC + widget.invoice.timbreFiscal),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Expanded(child: Text('Réf: ${widget.invoice.number}', style: TextStyle(fontWeight: FontWeight.w500))),
                          ...
                          Row(
                            children: [
                              Expanded(child: Text('Montant total: ${formatCurrencyDT(widget.invoice.totalTTC + widget.invoice.timbreFiscal)}', style: TextStyle(fontWeight: FontWeight.w600))),
                              Expanded(
                                child: Row(
                                  children: [
