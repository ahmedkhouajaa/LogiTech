                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Expanded(child: Text('Réf: ${widget.purchaseInvoice.number}', style: const TextStyle(fontWeight: FontWeight.w500))),
                          ...
                          Row(
                            children: [
                              Expanded(child: Text('Montant total: ${formatCurrencyDT(widget.purchaseInvoice.totalTTC + widget.purchaseInvoice.timbreFiscal)}', style: const TextStyle(fontWeight: FontWeight.w600))),
                              Expanded(
                                child: Row(
                                  children: [
