                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text(quote.number, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: AppColors.textPrimary)),
                                                SizedBox(height: 4),
                                                Text(formatDateTimeLong(quote.date), style: TextStyle(fontSize: 12, color: AppColors.textTertiary)),
                                              ],
                                            ),
                                          ),
                                          Expanded(
