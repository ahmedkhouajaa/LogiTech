...
class _QuotesScreenState extends State<QuotesScreen> {
  ...
  Widget _buildFilterBar(QuotesState state) {
    int totalItems = 0;
                                          ...
                                          SizedBox(
                                            ...
                                            child: Align(
                                              ...
                                              child: PopupMenuButton<String>(
                                                ...
                                                itemBuilder: (_) {
                                                   final canRead = PermissionService.instance.hasPermission('devis', action: 'read');
