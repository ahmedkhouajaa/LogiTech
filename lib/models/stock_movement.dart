...
class Warehouse {
  ...
  factory Warehouse.fromMap(Map<String, dynamic> map) {
    final rawName = (map['name'] ?? 'Entrepôt').toString();
    final nameLower = rawName.trim().toLowerCase();
    final isDefaultVal = map['is_default'] == 1 ||
        map['is_default'] == true ||
        map['isDefault'] == true ||
        nameLower == 'entrepôt par défaut' ||
        nameLower == 'entrepot par defaut';
    return Warehouse(
      id: (map['id'] ?? '').toString(),
      name: rawName,
