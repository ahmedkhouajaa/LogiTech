...
def process():
  ...
  return showDialog<String?>(
    ...
    # We need to add the closing tags for the `BlocBuilder` in showSupplierSelectDialog.
    # We will search for the end of the StatefulBuilder for showSupplierSelectDialog.
    # It ends right before `Future<String?> showProductSelectDialog(`
    end_supp_target = """                  ),
                ],
              ),
            ),
...
Future<String?> showProductSelectDialog("""
  ...
  return showDialog<String?>(
    ...
    # Find the end of showProductSelectDialog. It ends before `Future<String?> showWarehouseSelectDialog(` (if that exists) or at the end.
    end_prod_target = """                  ),
                ],
              ),
            ),
    ...
    # We only want to replace the first occurrence of end_prod_target AFTER we inserted rep_prod_start!
